...
import { BarChart, Bar, XAxis, YAxis, Legend, Line, CartesianGrid,
    PieChart, Pie, Tooltip, LineChart } from 'recharts';
...
// const data = [{name: 'Page A', uv: 400, pv: 2400, amt: 2400}, {name: 'Page B', uv: 1400, pv: 2100, amt: 1400}];
...
const Metrics = () => {
    ...
    const getData = () => {
        Axios.get('/facebook_post/1')
        .then(response => {
            setData(response.data)
        })

        Axios.get('/facebook_comments/1')
        .then(response => {
        ...
        <div>
            <Row>
                    ...
                    {/* <ReactTable 
                        ...
                        columns={
                            [
                                ...
                                {
                                    Header: () => <div className="Header">Status</div>,
                                    accessor: 'amt'
                                }
                            ]
                        }
                ...
                <Col sm="12" md="6" lg="6" xl="6">
                    ...
                    <BarChart width={600} height={300} data={commentData ? commentData.list: []}>
            ...
            <Row>
                <Col sm="12" md="6" lg="6" xl="6">
                    ...
                    <LineChart width={730} height={250} data={commentData ? commentData.list: []}
                ...
                <Col sm="12" md="6" lg="6" xl="6">
                    ...
                    <PieChart width={730} height={250}>
                        {/* <Pie data={data ? data.list : []} dataKey="post_likes" nameKey="post_username" cx="50%" cy="50%" outerRadius={50} fill="#8884d8" /> */}
